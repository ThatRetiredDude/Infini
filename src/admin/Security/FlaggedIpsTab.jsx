    ...
    <div className="space-y-6">
      ...
      {!loading && activeSection === 'repeat' && (
        <div className="space-y-3">
          ...
          <IpTable rows={repeatRows} source="fake data + HTTP decoys" emptyMsg="No repeat offenders yet." />
        </div>
      )}
      ...
      {!loading && activeSection === 'abuse' && (
        <div className="space-y-3">
          ...
          <IpTable rows={abuseRows} source="HTTP decoys / fake data" emptyMsg="No high-abuse IPs found. Configure AbuseIPDB API key in Integrations to enable scoring." />
        </div>
      )}
