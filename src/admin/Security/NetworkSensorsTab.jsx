...
export default function NetworkSensorsTab({ toast }) {
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between flex-wrap gap-3">
        ...
        <div className="flex items-center gap-3 flex-wrap">
          <ExportShareBar rows={rows} filename="network-sensor-events" source="network_sensor" filters={filter} toast={toast} />
